...
आप एक `selectedRef` डिक्लेअर कर सकते हैं, और फिर इसे केवल वर्तमान इमेज पर शर्तों के आधार पर पास कर सकते हैं:
...
#### अलग-अलग घटकों के साथ सर्च फील्ड पर फोकस करें {/*focus-the-search-field-with-separate-components*/}
