...
पिछले पांच साल में मिले हुए हजारो कंपोनेंट्स को लिखने और सम्भालनेका काम React Hooks से आसानी से किआ जा सकता हे।
यदि आप React सिख रहे हो, रोजमर्रा में उसे कर रहे हो, या कोई दूसरी लाइब्रेरी उसे करके कॉम्पोनेन्ट मॉडल्स बना रहे हो, आपको यह प्रोब्लेम्स जरूर मिले होंगे। 

### कंपोनेंट्स के बीच स्टैटिफुल लॉजिक लिखना बेचिदा हे {#its-hard-to-reuse-stateful-logic-between-components}
...
कम्पोनेनेट्स के साथ पुन: प्रयोज्य व्यवहार नहीं देता (उदहारण के तौर पर, स्टोर के साथ कनेक्शन करना)। आपने React में काम किआ रहेगा तोह आपको [render props](/docs/render-props.html) और [higher-order components](/docs/higher-order-components.html) पैटर्न से जानेपहचाने होंगे। जिस लिए आपको कॉम्पोनेन्ट का स्ट्रक्चर बदलना पड़ेगा।
