...
अब जब हमे अपने मॉक कौम्पोनॅन्ट की पहचान हो गई है, उन्हें अब हम पदक्रम में जमाएंगे। मॉक में, जो कौम्पोनॅन्ट दूसरे कौम्पोनॅन्ट के भीतर दिखाई दे रहे है, उन्हें पदक्रम में उनके चाइल्ड की तरह दिखाना होगा:
...
आप ऊपर-से-नीचे या नीचे-से-ऊपर बना सकते है. मतलब, या तो आप अपने कौम्पोनॅन्टस पदक्रम में ऊपर (अर्थात `FilterableProductTable` से शुरुवात) या सबसे नीचे (`ProductRow`) से शुरू कर सकते है। सरल उदाहरण में, बड़े प्रोजेक्ट्स में ऊपर-से-नीचे और टेस्ट लिखना नीचे-से-ऊपर करेंगे तो ज्यादा आसान होगा।
...
अपनी एप्प के हर state के भाग के लिए: 
  ...
  * यदि आप वह कौम्पोनॅन्ट नहीं पहचान पा रहे जो state का मालिक होना चाहिए, एक नया कौम्पोनॅन्ट बनाइये जो सिर्फ state रखेगा ओर उसे हायरार्की में कही कॉमन मुख्य कौम्पोनॅन्ट के ऊपर रख दीजिये।
...
अब तक हमने ऐसी एप्प बना ली जो हायरार्की से नीचे जाते हुए props ओर state से रेंडर सही से करती है। अब समय है डाटा के उलटे बहाव का: `FilterableProductTable` का state अपडेट होना चाहिए फॉर्म कॉम्पोनेन्ट के हायरार्की में।
