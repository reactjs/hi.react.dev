...
अगर किसी वजह से आपको ब्राउज़र के अंतर्निहित इवेंट की ज़रूरत है, तो इसे प्राप्त करने के लिए `nativeEvent` एट्रिब्यूट का उपयोग करें। Synthetic इवेंट ब्राउज़र के नेटिव इवेंट्स से अलग है और वो ब्राउज़र के नेटिव इवेंट के साथ सीधा मैप नहीं करता। उद्धरण के लिए `onMouseLeave` `event.nativeEvent` `mouseout` को पॉइंट करेगा। कोई भी मैपिंग पब्लिक API का हिस्सा नहीं है और कभी भी बदल सकता है। हर `SyntheticEvent` ऑब्जेक्ट में निम्न विशेषताएँ होती हैं:
