...
जब कभी भी React एक एलिमेंट को यूजर-डिफाइंड कौम्पोनॅन्ट का प्रतिनिधित्व करते हुए देखता है, तुरंत ही इन कौम्पोनॅन्टs को एक object के रूप में JSX ऐट्रिब्यूट्स पास कर देता है| हम इस object को "props" कहते हैं|
...
चलिए देकते है इस उदाहरण में क्या होता है:
...
3. हमारा `Welcome` कौम्पोनॅन्ट परिणाम के तौर पर वापस करता है `<h1>नमस्ते, Sara</h1>` एलिमेंट|
4. React DOM कुशलता पूर्वक DOM को `<h1>नमस्ते, Sara</h1>` से अपडेट करता है|

>**ध्यान दें:** हमेशा रेंकौम्पोनॅन्टस की नाम की शुरुवात कैपिटल लेटर से होनी चाहिए|
>
