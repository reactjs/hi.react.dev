...
**React** एक जावास्क्रिप्ट लाइब्रेरी है जो उपयोगकर्ता को इंटरफेसेस बनाने में काम आती है | [हमारे होमपेज](/) पर या [इस टुटोरिअल](/tutorial/tutorial.html) पर सीखें की React किस चीज़ के बारे में है |
 ...
 - [रियेक्ट का प्रयोग करके देखें](#try-react)
...
लोग React सिखने अलग-अलग बैकग्राउंडस से आते हैं, उनके सिखने के ढंग भी अलग-अलग होते है | चाहे आप थेओरिटिकल ढंग से सीखना चाहे या एक ज़्यादा प्रैक्टिकल ढंग से , हम आशा करते हैं कि यह अनुभाग आपके लिए मददगार साबित होगा |

* अगर आप **कर - कर** सीखना पसंद करते हैं, हमारे [प्रैक्टिकल टुटोरिअल](/tutorial/tutorial.html) के साथ शुरू करें | 
* अगर आप इस **कॉन्सेप्ट्स को क्रमशः** सीखना पसंद करते हैं, हमारी [मुख्य धारणा कि गाइड](/docs/hello-world.html) से शुरू करें |
