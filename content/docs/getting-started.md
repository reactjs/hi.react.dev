...
**React** उपयोगकर्ता इंटरफेस के निर्माण के लिए एक जावास्क्रिप्ट लाइब्रेरी है | React के बारे में जान्ने के लिए [हमारे होमपेज](/) पर [यह टुटोरिअल](/tutorial/tutorial.html को देखें |
...
>सुझाव 
>
>जब भी आप किसी जावास्क्रिप्ट की चीज़ की वजह से उलझन में पड जाएं तो [MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript) और  [javascript.info](https://javascript.info/) अपने आप सही करने के लिए बहुत अछि वेबसीटे हैं | [कम्युनिटी सहायता मंच](/community/support.html) पे आप मदद माँग सकते हैं |
...
जब आप [मुख्य कन्सेप्टों](#main-concepts) से आरामदायक हो जाएं और React का थोड़ा अभ्यास करलें, हो सकता है आपको एडवांस्ड विषयों भी में दिलचस्पी हों | यह भाग आपको ताकतवर लेकिन कम इस्तेमाल किये जाने वाली React की खासियत जैसे [context](/docs/context.html) और [refs](/docs/refs-and-the-dom.html) से आपका परिचय करवाएगा।

### ए.पी.आई. रिफरेन्स {#api-reference}

यह दस्तावेज़ का भाग काम का है अगर आप किसी विशेष React ए.पी.आई. के बारे में और जानना चाह रहें हों | उदहारण के लिए, [`React.Component` ए.पी.आई. रिफरेन्स](/docs/react-component.html) आपको `setState()` कैसे काम करता है, और दूसरे लाइफसाइकिल मेथड्स किस काम के हैं इनपर आपको विवरण दे सखता है | 

### शब्दकोष और FAQ {#glossary-and-faq}

यह [शब्दकोष](/docs/glossary.html) React के दस्तावेज़ों में सबसे ज़्यादा बार आने वाले शब्दों का एक ओवरव्यू है | [AJAX रिक्वैस्ट करना](/docs/faq-ajax.html), [कॉम्पोनेन्ट state](/docs/faq-state.html), और [फाइल स्ट्रक्चर](/docs/faq-structure.html) के साथ यहाँ सामान्य प्रश्नों के बारे में संक्षिप्त प्रश्न और उत्तर के लिए एक FAQ सेक्शन भी है | 

## जागृत रहें {#staying-informed}

[React ब्लॉग](/blog/) React टीम के द्वारा अपडेट्स के लिए एक ऑफिसियल स्रोत है, इसमें कोई भी आवशयक सुचना जैसे की रिलीज़ नोट्स और डेप्रिसिएशन की सूचनाए सबसे पहले आती हैं |
...
हर React रिलीज़ अपने ब्लॉग पोस्ट के लायक नहीं है लेकिन हर रिलीज़ का पूरा चेंज लोग आपको [`CHANGELOG.md` फाइल जो React की रिपॉजिटरी में है](https://github.com/facebook/react/blob/master/CHANGELOG.md) या [Release](https://github.com/facebook/react) पेज पर मिल जाएगा | 
