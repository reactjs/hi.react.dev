...
ध्यान दीजिये की हमने दिए गए इनपुट नाम के लिए state key को अपडेट करने के लिए ES6 [कंप्यूटेड प्रॉपर्टी नाम](https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Operators/Object_initializer#Computed_property_names) सिंटेक्स का उपयोग किया है।
...
और क्यूंकि `setState()` अपनेआप [एक आंशिक state को अभी के state में मिला देता है](/docs/state-and-lifecycle.html#state-updates-are-merged)], इसीलिए हमे इसे सिर्फ बदले हुए हिस्सों के लिए उपयोग करना होगा।
