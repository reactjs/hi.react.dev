...
JSX आपको लॉजिक और कंटेंट को एक ही स्थान पर रख कर, JavaScript फ़ाइल के अंदर HTML जैसा मार्कअप लिखने देता है। कभी-कभी आप थोड़ा JavaScript लॉजिक ऐड करना चाहेंगे या उस मार्कअप के अंदर एक डायनामिक प्रॉपर्टी का रिफरेन्स देना चाहेंगे। इस स्थिति में, आप JavaScript के लिए एक विंडो खोलने के लिए अपने JSX में कर्ली ब्रेसेस का उपयोग कर सकते हैं।
</Intro>
...
क्लासनाम = "अवतार" के बीच अंतर पर ध्यान दें, जो एक "अवतार" CSS वर्ग का नाम निर्दिष्ट करता है जो छवि को गोल बनाता है, और src={अवतार} जो अवतार नामक JavaScript चर के मूल्य को पढ़ता है। ऐसा इसलिए है क्योंकि कर्ली ब्रेसेस आपको अपने मार्कअप में वहीं JavaScript के साथ काम करने देते हैं!

## कर्ली ब्रेसेस का उपयोग: JavaScript दुनिया में एक खिड़की {/*using-curly-braces-a-window-into-the-javascript-world*/}

JSX JavaScript लिखने का एक विशेष तरीका है। इसका मतलब है कि इसके अंदर JavaScript का उपयोग करना संभव है - कर्ली ब्रेसेस के साथ `{ }`। नीचे दिया गया उदाहरण पहले वैज्ञानिक के नाम की घोषणा करता है, `name`, फिर उसे `<h1>` के अंदर कर्ली ब्रेसेस के साथ एम्बेड करता है:
...
कोई भी JavaScript अभिव्यक्ति कर्ली ब्रेसेस के बीच काम करेगी, जिसमें फ़ंक्शन कॉल जैसे `formatDate ()` शामिल हैं:
...
2. **एट्रिब्यूटओं के रूप में** तुरंत `=` चिह्न के बाद: `src={avatar}` `अवतार` चर को पढ़ेगा, लेकिन `src="{avatar}"` स्ट्रिंग `{अवतार}` को पास करेगा .

## "डबल कर्ली" का उपयोग करना: JSX में CSS और अन्य ऑब्जेक्ट {/*using-double-curlies-css-and-other-objects-in-jsx*/}

strings, नंबर्स और अन्य JavaScript एक्सप्रेशंस के अलावा, आप JSX में ऑब्जेक्ट्स को पास भी कर सकते हैं। वस्तुओं को कर्ली ब्रेसेस से भी दर्शाया जाता है, जैसे `{name: "Hedy Lamarr", आविष्कार: 5 }`। इसलिए, JSX में JS ऑब्जेक्ट को पास करने के लिए, आपको ऑब्जेक्ट को कर्ली ब्रेसेस की एक और जोड़ी में लपेटना होगा: `व्यक्ति = {{नाम: "Hedy Lamarr", आविष्कार: 5}}`।

आप इसे JSX में इनलाइन CSS शैलियों के साथ देख सकते हैं। प्रतिक्रिया के लिए आपको इनलाइन शैलियों का उपयोग करने की आवश्यकता नहीं है (CSS कक्षाएं ज्यादातर मामलों के लिए बहुत अच्छा काम करती हैं)। लेकिन जब आपको इनलाइन शैली की आवश्यकता होती है, तो आप ऑब्जेक्ट को `style` एट्रिब्यूट में पास करते हैं:
...
जब आप इसे इस तरह लिखते हैं तो आप वास्तव में JavaScript ऑब्जेक्ट को कर्ली ब्रेसेस के अंदर देख सकते हैं:
...
आप कई भावों को एक वस्तु में स्थानांतरित कर सकते हैं, और उन्हें अपने JSX में कर्ली ब्रेसेस के अंदर संदर्भित कर सकते हैं:
...
JSX एक टेम्प्लेटिंग भाषा के रूप में बहुत कम है क्योंकि यह आपको JavaScript का उपयोग करके डेटा और लॉजिक को व्यवस्थित करने देता है।

<Recap>

अब आप JSX के बारे में लगभग सब कुछ जानते हैं:

* उद्धरण के अंदर JSX एट्रिब्यूटएँ तार के रूप में पारित की जाती हैं।
* कर्ली ब्रेसेस आपको अपने मार्कअप में JavaScript लॉजिक और चर लाने देते हैं।
...
ऐसा इसलिए हो रहा है क्योंकि यह उदाहरण एक स्ट्रिंग के बजाय मार्कअप में *एक ऑब्जेक्ट ही* रेंडर करता है: `<h1>{person}'s Todos</h1>` पूरे `person` ऑब्जेक्ट को रेंडर करने की कोशिश कर रहा है! कच्ची वस्तुओं को पाठ कंटेंट के रूप में शामिल करना एक त्रुटि उत्पन्न करता है क्योंकि React यह नहीं जानता कि आप उन्हें कैसे प्रदर्शित करना चाहते हैं।
