...
## Step 1: एक कुम्पोनेंट पदानुक्रम में UI को तोड़ो {/_step-1-break-the-ui-into-a-component-hierarchy_/} 

मॉकअप में प्रत्येक कौम्पोनॅन्ट और सबकौम्पोनॅन्ट के चारों ओर बॉक्स बनाकर शुरू करें और उनका नामकरण करें।
यदि आप किसी डिज़ाइनर के साथ काम करते हैं, तो हो सकता है कि उन्होंने अपने डिज़ाइन टूल में इन कौम्पोनॅन्टस का नाम पहले ही रख लिया हो। उनके साथ चेक करलें!
...
5. `ProductRow` (yellow) प्हर प्रोडक्ट के लिए एक पंक्ति डिस्प्ले करता है।

</CodeDiagram>

</FullWidth>

यदि आप `ProductTable` (लैवेंडर) को देखते हैं, तो आप देखेंगे कि तटेबल का हैडर (जजिसमें "Name" और "Price" लेबल शामिल हैं) इसका अपना कौम्पोनॅन्ट नहीं है। यह अपनी पसंद का मामला है, और आप किसी भी तरह से कर सकते हैं। इस उदाहरण के लिए, यह `productTable` का एक हिस्सा है क्योंकि यह `ProductTable` सूची के अंदर दिखाई देता है। हालांकि, अगर यह हैडर काम्प्लेक्स हो जाता है (उदाहरण के लिए, यदि आप सॉर्टिंग ऐड करते हैं), तब ऐसे अपना खुद का `ProductTableHeader` कौम्पोनॅन्ट बनाना सही रहेगा।

अब जब आपने मॉकअप में कौम्पोनॅन्ट की पहचान की है, तो उन्हें पदानुक्रम में व्यवस्थित करें। कुम्पोनानेंट जो मॉकअप में एक और कौम्पोनॅन्ट के भीतर दिखाई देता है पदानुक्रम में एक बच्चे के रूप में प्रकट होना चाहिए:
...
## Step 2: Build a static version in React {/*step-2-build-a-static-version-in-react*/} {/*step-2-build-a-static-version-in-react-step-2-build-a-static-version-in-react*/}
...
अपने घटकों के निर्माण के बाद, आपके पास पुन: प्रयोज्य घटकों की एक पुस्तकालय होगी जो आपके डेटा मॉडल को प्रस्तुत करते हैं। चूंकि यह एक स्थिर ऐप है, घटक केवल जेएसएक्स वापस कर देंगे। पदानुक्रम के शीर्ष पर घटक (`FilterableProductTable`) c इसे *ऑन-वे डेटा फ्लो* कहा जाता है क्योंकि डेटा पेड़ के निचले हिस्से में शीर्ष-स्तरीय घटक से नीचे बहती है।
...
## Step 3: UI राज्य का न्यूनतम लेकिन पूर्ण प्रतिनिधित्व खोजें {/*step-3-find-the-minimal-but-complete-representation-of-ui-state*/} {/*step-3-ui-राज्य-का-न्यूनतम-लेकिन-पूर्ण-प्रतिनिधित्व-खोजें-step-3-find-the-minimal-but-complete-representation-of-ui-state*/}

UI इंटरैक्टिव बनाने के लिए, आपको उपयोगकर्ताओं को अपने अंतर्निहित डेटा मॉडल को बदलने की आवश्यकता है। आप इसके लिए *राज्य* का उपयोग करेंगे।
...
## Step 4: पहचानें कि आपके राज्य को कहाँ रहना चाहिए {/*step-4-identify-where-your-state-should-live*/} {/*step-4-identify-where-your-state-should-live-step-4-identify-where-your-state-should-live*/}
...
## Step 5: उलटा डेटा प्रवाह जोड़ें {/*step-5-add-inverse-data-flow*/} {/*step-5-add-inverse-data-flow-step-5-add-inverse-data-flow*/}
