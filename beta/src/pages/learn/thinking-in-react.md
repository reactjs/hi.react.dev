...
React आपके द्वारा देखे जाने वाले डिज़ाइन और आपके द्वारा बनाए गए ऍप्स के बारे में आपके सोचने के तरीके को बदल सकता है। जहां एक बार आपने जंगल को देखा है, React के साथ काम करने के बाद, आप अलग-अलग पेड़ों की सराहना करेंगे। React डिजाइन सिस्टम और UI states में सोचना आसान बनाता है.इस ट्यूटोरियल में, हम आपको React के साथ खोज योग्य उत्पाद डेटा तालिका बनाने की विचार प्रक्रिया के माध्यम से मार्गदर्शन करेंगे।
...
आपकी बैकग्राउंड के आधार पर, आप किसी डिज़ाइन को विभिन्न तरीकों से कॉम्पोनेन्टस में विभाजित करने के बारे में सोच सकते हैं:
