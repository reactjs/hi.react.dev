...
React आपके द्वारा देखे जाने वाले डिज़ाइन और आपके द्वारा बनाए गए ऍप्स के बारे में आपके सोचने के तरीके को बदल सकता है।जहां एक बार आपने जंगल को देखा है, React के साथ काम करने के बाद, आप अलग-अलग पेड़ों की सराहना करेंगे।React डिजाइन प्रणाली और UI states में सोचना आसान बनाता है.इस ट्यूटोरियल में, हम आपको React के साथ खोज योग्य उत्पाद डेटा तालिका बनाने की विचार प्रक्रिया के माध्यम से मार्गदर्शन करेंगे।

</Intro>

## मॉकअप के साथ शुरू करें {/*स्टार्ट-विद-द-मॉकअप*/}

कल्पना करें कि आपके पास पहले से ही JSON API और एक डिजाइनर से एक मॉकअप है।
...
React  में  UI  को लागू करने के लिए, आप आमतौर पर एक ही पांच चरणों का पालन करेंगे।

## Step 1: एक कुम्पोनेंट पदानुक्रम में UI को तोड़ो {/*step-1-break-the-ui-into-a-कौम्पोनॅन्ट-hierarchy*/}

मॉकअप में प्रत्येक कॉम्पोनेन्ट और सब कंपोनेंट के चारों ओर बॉक्स बनाकर शुरू करें और उनका नामकरण करें।
यदि आप किसी डिज़ाइनर के साथ काम करते हैं, तो हो सकता है कि उन्होंने अपने डिज़ाइन टूल में इन कॉम्पोनेंट्स का नाम पहले ही रख लिया हो। उनके साथ चेक इन करें!

आपकी पृष्ठभूमि के आधार पर, आप किसी डिज़ाइन को विभिन्न तरीकों से घटकों में विभाजित करने के बारे में सोच सकते हैं:
