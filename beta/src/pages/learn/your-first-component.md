...
React आपको अपने मार्कअप, CSS और जावास्क्रिप्ट को कस्टम "कौम्पोनॅन्ट," **आपके एप्प के लिए री-यूज़ब्ले UI एलिमेंट्स** में संयोजित करने देता है। ऊपर देखी गई सटेबल ऑफ़ कंटेंट्स कोडा को `<TableOfContents />` कौम्पोनॅन्ट में बदल दिया जा सकता है आप हर पेज पर रेंडर कर सकते हैं। हुड के तहत, यह अभी भी उसी HTML टैग का उपयोग करता है जैसे `<article>`, `<h1>`, आदि।
