...
### कंडीशनली के आधार पर `null` को रिटर्न करें {/*conditionally-returning-nothing-with-null*/}

कुछ स्थितियों में, आप कुछ भी रेंडर नहीं करना चाहेंगे। उदाहरण के लिए, मान लें कि आप पैक्ड आइटम बिल्कुल नहीं दिखाना चाहते हैं। एक कौम्पोनॅन्ट को कुछ रिटर्न करना होगा। इस केस में, आप `null` रिटर्न कर सकते हैं:
...
यदि `isPacked` सत्य है, तो कौम्पोनॅन्ट कुछ भी नहीं लौटाएगा, `null`। अन्यथा, यह JSX को रेंडर करने के लिए रिटर्न कर देगा।
...
व्यवहार में, किसी कौम्पोनॅन्ट से `null` लौटाना आम बात नहीं है क्योंकि यह इसे रेंडर करने की कोशिश कर रहे डेवलपर को आश्चर्यचकित कर सकता है। अधिक बार, आप पैरेंट कौम्पोनॅन्ट के JSX में कौम्पोनॅन्ट को कंडीशनल रूप से शामिल या बहिष्कृत करेंगे। यहाँ यह कैसे करना है!

## कंडीशन के आधार पर JSX को इन्क्लुडे करें {/*conditionally-including-jsx*/}

पिछले उदाहरण में, आपने नियंत्रित किया था कि कौन सा (यदि कोई हो!) JSX ट्री कौम्पोनॅन्ट से लौटाया जाएगा। आपने पहले ही रेंडर आउटपुट में कुछ दोहराव देखा होगा:
...
दोनों कंडीशनल शाखाएं `<li className="item">...</li>` लौटाती हैं:
...
हालांकि यह दोहराव हानिकारक नहीं है, लेकिन यह आपके कोड को बनाए रखना कठिन बना सकता है। क्या होगा यदि आप `className` को बदलना चाहते हैं? आपको इसे अपने कोड में दो स्थानों पर करना होगा! ऐसी स्थिति में, आप अपने कोड को और अधिक [DRY](https://en.wikipedia.org/wiki/Don%27t_repeat_yourself) बनाने के लिए कंडीशनल रूप से थोड़ा JSX शामिल कर सकते हैं।

### Conditional (ternary) operator (`? :`) {/*conditional-ternary-operator--*/}

कंडीशनल अभिव्यक्ति लिखने के लिए JavaScript में एक कॉम्पैक्ट सिंटैक्स है - [कंडीशनल ऑपरेटर](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Conditional_Operator) या "टर्नरी ऑपरेटर।"
...
आप इसे इस प्रकार पढ़ सकते हैं *"यदि `isPacked` सत्य है, तो (`?`) `name +' ✔'` रेंडर करें, अन्यथा (`:`) `name` रेंडर करें।"*)
...
अब मान लें कि आप पूर्ण किए गए आइटम के टेक्स्ट को किसी अन्य HTML टैग में लपेटना चाहते हैं, जैसे `<del>` को बाहर निकालने के लिए। आप और भी नई पंक्तियाँ और कोष्ठक जोड़ सकते हैं ताकि प्रत्येक केस में अधिक JSX को घोंसला बनाना आसान हो:
