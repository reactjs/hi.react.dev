...
जिस HTML पृष्ठ में आप संपादित करना चाहते हैं, जहां आप React के साथ कुछ प्रदर्शित करना चाहते हैं, उस स्थान पर एक खाली `<div>` टैग के साथ एक अनोखा ‘id’ वाला HTML एलमन्ट जोड़ें।

आप इस तरह का "कंटेनर" एलमन्ट `<div>` को `<body>` टैग के अंदर कहीं भी रख सकते हैं। React HTML एलमन्ट के अंदर किसी भी मौजूदा सामग्री को बदल देगा, इसलिए वे आमतौर पर खाली होते हैं। आपके पास इन HTML एलमन्ट में से एक पृष्ठ पर जितनी आवश्यकता हो उतनी हो सकती है।

```html {3}
<!-- ... मौजूदा HTML ... -->

<div id="एलमन्ट-यहाँ-जाएगा"></div>
...
### Add JSX to a project {/_add-jsx-to-a-project_/} {/*add-jsx-to-a-project-add-jsx-to-a-project*/}
...
### Run the JSX Preprocessor {/_run-the-jsx-preprocessor_/} {/*run-the-jsx-preprocessor-run-the-jsx-preprocessor*/}
