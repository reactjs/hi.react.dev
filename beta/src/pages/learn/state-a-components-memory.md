...
जब आप अंतिम मूर्तिकला पर "next" बटन दबाते हैं, तो कोड क्रैश हो जाता है (काम करना बंद कर देता है)। इस क्रैश को रोकने के लिए लॉजिक को ठीक करें। आप ईवेंट हैंडलर में अतिरिक्त लॉजिक जोड़कर ऐसा कर सकते हैं या एक्शन असंभव होने पर बटन को डिसएबल करके।
...
यह दोनों ईवेंट हैंडलर के अंदर एक सुरक्षा कंडीशन जोड़ता है और जरूरत पड़ने पर बटन को डिसएबल कर देता है:
...
जब आप इनपुट फ़ील्ड में टाइप करते हैं, तो कुछ भी नहीं दीखता है। यह ऐसा है जैसे इनपुट वैल्यूज खाली strings के साथ "अटक" गए हैं। पहले `<input>` का `वैल्यू` हमेशा `firstName` वेरिएबल से मेल खाने के लिए बाध्य है, और दूसरे `<इनपुट>` के लिए `वैल्यू` हमेशा `lastName` वैरिएबल से मेल खाने के लिए बाध्य है। यह सही है। दोनों इनपुट में `onChange` event handler हैं, जो उपयोगकर्ता के नये इनपुट के आधार पर वेरिएबलो को अपडेट करने का प्रयास करते हैं (`e.target.value`). हालांकि, वेरिएबल री-रेंडर के बीच अपने वैल्यूज को "याद" नहीं कर पाता। इसके बजाय state वेरिएबल का उपयोग करके इसे ठीक करें।
