...
useState` केवल एक ही आर्गुमेंट लेता है और वह है **इनिशियल वैल्यू** आपके state वेरिएबल का। इस उदाहरण में, `index` की इनिशियल वैल्यू है `0` क्युकी `useState(0)` लिखा गया हे। 
...
2. **आप state को अपडेट करें।** जब कोई यूजर, बटन पर क्लिक करता है, यह कॉल करता है : `setIndex(index + 1)` को, `index` अभी `0` है, तो `setIndex(1)` हो जायेगा। यह react को याद रखने के लिए कहता है कि `index` अब `1` है और एक और रेंडर ट्रिगर करता है।
