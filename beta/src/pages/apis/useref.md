...
`useRef` single <CodeStep step={2}>`current` प्रॉपर्टी</CodeStep> के सात <CodeStep step={1}>ref ऑब्जेक्ट</CodeStep> को return करता है जिससे initially आपके द्वारा दिया गया <CodeStep step={3}>initial वैल्यू</CodeStep> के सात set है.
...
* In Strict Mode, React will **call your component function twice** in order to [help you find accidental impurities](#my-initializer-or-updater-function-runs-twice). This is development-only behavior and does not affect production. This means that each ref ऑब्जेक्ट will be created twice, and one of the versions will be discarded. If your component function is pure (as it should be), this should not affect the logic of your component.
